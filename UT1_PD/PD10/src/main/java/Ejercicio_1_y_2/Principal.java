...
public class Principal {
    public static void main(String[] args) {
        ...
        String archivo= "D:\\UCU\\ALGORITMOS\\UT1\\PD10\\src\\main\\java\\Ejercicio_3\\UT1_TA3_ARCHIVO_EJEMPLO.txt";
        ArrayList<String> var= ejercicio3.leerArchivo(archivo);
        int totalPalabras = 0;
        for (int cont = 0; cont < var.size(); cont++){
            System.out.println("La linea " + cont + " tiene: " + cp.cantidadPalabras(var.get(cont)) + " palabras");         
