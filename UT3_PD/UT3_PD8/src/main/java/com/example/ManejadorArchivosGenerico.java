...
/**
 * Clase que proporciona métodos estáticos para leer y escribir archivos de
 * texto.
 */
public class ManejadorArchivosGenerico {
     ...
     * @param listaLineasArchivo    Un array de strings, cada uno de los cuales se
     *                              escribirá como una línea en el archivo.
     ...
     * @return Un array de strings, cada uno de los cuales contiene una línea del
     *         archivo.
